...
> [!WARNING]
> Parte de la tarea es diseñar el número y la distribución de datos en las tablas para que las pruebas tengan sentido. Para mayor facilidad el script lee un archivo `yaml` en donde usted puede definir el número de datos por cada prueba. **En los entregables tiene que decir el número de datos y distribución para cada prueba y la justificación de los mismos**. Para saber lo que se espera de este entregable puede ir al
