...
El siguiente tutorial usará la herramienta CloudShell para crear los grupos de seguridad, de igual forma si desea usar la consola de AWS puede seguir el siguiente [tutorial]([https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/creating-security-group.html))
...
``` bash
aws ec2 create-security-group --group-name <NOMBRE_GRUPO> --description "<DESCRIPCION_SG>" --vpc-id <SU_VPCID>
```
...
Recuerde que el CIDR representa una porción de red, en este caso la que queremos que tenga acceso a través de esta regla (`0.0.0.0/0` es el CIDR que cubre todas las direcciones IPv4 o anywhere-IPv4).
